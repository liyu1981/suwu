...
/**
 * Settings screen for the unified Suwu menu dialog. Font-size steppers act on
 * the live shared size immediately (visible in every open pane); "Save as
 * default" persists it as the size new sessions and Reset start from. Font
 * family and theme colors apply and persist instantly, syncing to every pane
 * via storage events.
 */
export default function SettingsView(props: { onClose: () => void }) {
  const { onClose } = props
