...
registerTilePlugin({
  id: 'xdisplay',
  get label() {
    return i18n.t('plugin.xdisplay');
  },
  get description() {
    return i18n.t('plugin.xdisplayDesc');
  },
  supportedParams: [
    {
      key: 'display',
      label: 'Display number',
      description: 'X11 display number (default: 99). Xorg is started automatically.',
      defaultValue: '99',
    },
    {
      key: 'title',
      label: 'Window title',
      description:
        'Capture a specific window by WM_CLASS or name (default: largest window, auto-picked)',
    },
    {
      key: 'desktop',
      label: 'Full desktop',
      description: 'Set to 1 to capture the whole desktop instead of the app window',
    },
