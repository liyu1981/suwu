...
export function ContextMenu({
  ...
  if (showNewFolder) {
    return (
      ...
      >
        <div className="mb-2 text-base font-semibold tracking-wide text-white/60">
          {t('filebrowser.newFolderTitle')}
        </div>
        <input
          type="text"
          value={newFolderName}
...
function MenuItem({
  ...
  return (
    ...
    >
      {icon && (
        <span className="w-4 shrink-0 text-white/30 transition-colors group-hover:text-white/50">
          {icon}
        </span>
      )}
      {label}
