  ...
  return (
    ...
    >
      ...
      >
        ...
        <pre className="scrollbar-thin max-h-24 overflow-auto whitespace-pre-wrap break-all rounded bg-black/20 p-2 font-mono text-sm">
          {search.query}
        </pre>
        <form
        ...
        >
          ...
          <button
            type="submit"
            disabled={!search.directory || opening}
